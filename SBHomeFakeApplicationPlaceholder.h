 ...
 */
//Kind of curious if anyone ever tried manipulating these to act like regular apps downloaded from the store, so the 
// Provisional profiles could be deleted, and they could be installed with AppSync, or Troll Store if compatible.
